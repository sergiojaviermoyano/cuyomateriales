        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-xs-5" style="min-height: 100px;">
                ...
                <h2 id="total">0.00</h2>
                <a href="assets/reports/reporteDeEgresos.pdf" id="linkDownload" download style="display: none;">Descargar en formato PDF<i class="fa fa-fw fa-file-pdf-o" style="color: red"></i></a>
            </div>
          </div>
        </div><!-- /.box-body -->
      </div><!-- /.box -->
  ...
  $('#btnSave').click(function(){
    ...
    WaitingOpen('Calculando Ingresos');
    	$.ajax({
    		...
    		url: 'index.php/report/getVt', 
    		success: function(result){
                			WaitingClose();
                      if(result.crdDebe != null){
                			 $('#total').html(result.crdDebe);
                      }else{
                        $('#total').html('0.00');
                      }
                      $('#linkDownload').show();
